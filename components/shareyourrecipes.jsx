...
const ShareRecipes = () => {
  ...
  return (
    <section id="shareRecipes" className='w-full mt-5 md:mt-10'>
        <div className='flex flex-col justify-between items-center gap-y-4 md:flex-row md:justify-between md:items-center px-8 md:px-10 lg:px-14  md:py-16 md:gap-x-20 py-8'>
                ...
                <div className='flex flex-col gap-y-4 justify-center items-center'>
                    ...
                    <button className='bg-primary text-white rounded-lg px-3 py-1.5 justify-center font-medium cursor-pointer' onClick={() => router.push('/add-recipe')}>Create New Recipe</button>
                </div>
        </div>
    </section>
  )
